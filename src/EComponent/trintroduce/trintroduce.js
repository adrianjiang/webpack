...
define(function(){
    let ec = new E.EC_ajax({
        dataFormat: 'title=bumenname&name=name&img=img&c1=course[0].name&c2=course[1].name&c3=course[2].name&c4=course[3].name&teacherid=id',
        interface: "hdteacher",
    ...
    ec.didLoad = function($dom,option){
            ...
            new Swiper($dom.search('ec-box','swipePage2')[0], {
                ...
                onTap: function(e){
                    var id = $(e.clickedSlide).attr('tap-href');
                    MPhd.load('m_teacherClass',{
                        id:id
                    })
                }
            });
